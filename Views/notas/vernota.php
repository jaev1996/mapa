...
<head>
    ...
    <title>Ver Nota de Entrega</title>
</head>
    ...
    <center>
        ...
        <div class="card col-md-8">
            <div class="card-header mt-2 bg-primary">
                <h2 class="text-white">Nota de Entrega Nro: <?php echo $this->venta['codigoVenta']; ?></h2>
            </div>
            <div class="card-body">
                ...
                <table class="col-md-12 text-center table table-sm table-bordered text-dark table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td><?php echo $this->venta['fechaVenta']; ?></td>
                                ...
                                <td><?php echo $this->venta['tipoPago']; ?></td>
                            </tr>
                        </tbody>
                </table>
                ...
                <table class="col-md-12 text-center table table-sm table-bordered text-dark table-hover">
                        ...
                        $total = 0;
                        $conteo = 0;
                        $listado = new Repuesto();
                        $listado = $this->historico;
                        ...
                        ?>
                            ...
                            <input type="number" name="subtotal[]" hidden="true" value="<?php echo $row->subtotal; ?>">
            ...
            <div class="card-footer">
                <input type="text" name="fecha" value="<?php echo $this->venta['fechaVenta']; ?>" id="" hidden="true">
                ...
                <input type="text" name="tipoPago" value="<?php echo $this->venta['tipoPago']; ?>" id="" hidden="true">
                <input type="text" name="total" value="<?php echo $total; ?>" id="" hidden="true">
                <input type="text" name="numeroNota" value="<?php echo $this->venta['codigoVenta']; ?>" id="" hidden="true">
                <input type="number" name="repeticiones" value="<?php echo $conteo; ?>" id="" hidden="true">
                <p><a href="<?php echo constant("URL"); ?>notas/verListadoNotas/" class="mr-4 btn btn-sm btn-danger">Volver</a><input type="submit" class="btn btn-sm btn-success" value="Imprimir Excel"></p>
            </div>
            </form>

        ...
        <div class="card col-md-6">
            ...
            <div class="card-body">
                <div class="form-row justify-content-center">
                    ...
                    <select class="form-control form-control-sm" name="idCliente" id="">
                        <option value="NULL">Seleccione un Cliente</option>
                        <?php foreach($this->cliente as $row){ ?>
                        <option value="<?php echo $row->codigoCliente; ?>"> <?php echo $row->codigoCliente." ".$row->nombreCliente; ?></option>
                        <?php }?>
                    </select>
                    </div>
                </div>

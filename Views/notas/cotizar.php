    ...
    <form action="<?php echo constant('URL'); ?>notas/realizarNota" method="POST">
        ...
        <div class="card col-md-6">
            <div class="card-header mt-2 bg-primary">
                <h2 class="text-white">Cotizaci&oacute;n </h2>
            </div>
            <div class="card-body">
            ...
            <div class="form-row justify-content-right">
                    <label class="float-right h5" for=""><strong>Total: <?php echo $total; ?></strong></label>
                </div>
            </div>
            <div class="card-footer">
                <p><a href="<?php echo constant("URL"); ?>notas/cotizacion" class="mr-4 btn btn-sm btn-danger">Volver</a></p>
            </div>
        </div>
